...
<head>
    ...
    <title>ZenCart | E-Commerce </title>
 ...
 <div class="offer">
    <div class="small-container">
        <div class="row">
            ...
            <div class="col-2">
               <p>Exclusively Available on ZenCart</p>
               <h1>Smart Band 4</h1>
               <small> The Mi Smart Band 4 features 
                0baksjbiciabiavcuavcvauivcuavcasv</small>
        ...
        <div class="small-container">
            <div class="row">
                <div class="col-3">
                    ...
                    <p>dnwdbwjqibfiqbfuwndoqwbf
                        fjefniwejbfiweubfehwbuiewbgu
                        ebgbbuqbfebgegbowbsfbiubfuqbfiuq</p>
                        <div class="rating">
                            <i class='bx bxs-star'></i>
                            <i class='bx bxs-star'></i>
                            <i class='bx bxs-star'></i>
                ...
                <div class="col-3">
                    <i class="fa fa-qoute-left" ></i>
                    <p>dnwdbwjqibfiqbfuwndoqwbf
                        fjefniwejbfiweubfehwbuiew
                        bguebgbbuqbfebgegbowbsfbiubfuqbfiuq</p>
                        <div class="rating">
                            <i class='bx bxs-star'></i>
                            <i class='bx bxs-star'></i>
                            <i class='bx bxs-star'></i>
                ...
                <div class="col-3">
                    <i class="fa fa-qoute-left" ></i>
                    <p>dnwdbwjqibfiqbfuwndoqwbf
                        fjefniwejbfiweubfehwbuiewbguebg
                        bbuqbfebgegbowbsfbiubfuqbfiuq</p>
                        <div class="rating">
                            <i class='bx bxs-star'></i>
                            <i class='bx bxs-star'></i>
                            <i class='bx bxs-star'></i>
